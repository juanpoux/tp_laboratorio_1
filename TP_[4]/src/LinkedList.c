...
LinkedList* ll_newLinkedList(void)
{
	...
	//OJO, que pase el test no significa que este bien
	return this;
}
...
static int addNode(LinkedList *this, int nodeIndex, void *pElement)
{
	...
	if(nodo != NULL && this != NULL && nodeIndex >= 0 && nodeIndex <= tam)
	{
		if(nodeIndex == 0)
		{
...
int ll_push(LinkedList *this, int index, void *pElement)
{
	...
	tam = ll_len(this);
	nodo = (Node*) malloc(sizeof(Node));
	if(nodo != NULL && this != NULL && index >= 0 && index <= tam)
	{
		if(index == 0)
		{
			nodoAux = getNode(this, index);
			nodo->pElement = pElement;
			nodo->pNextNode = nodoAux;
			this->pFirstNode = nodo;
		}
		else
		{
			nodoAux = getNode(this, index - 1);
			nodo->pElement = nodoAux->pNextNode;
